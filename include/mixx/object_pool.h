#ifndef _MIXX_OBJECT_POOL_H_
#define _MIXX_OBJECT_POOL_H_
...
public:
    ...
    MIXX_FORCEINLINE size_t num_clusters() const {
        return _num_nodes;
    }

    MIXX_FORCEINLINE size_t capacity() const {
        return _capacity;
    }
...
protected:
    ...
    MIXX_FORCEINLINE cluster_node* _allocate_node() {
    ...
    MIXX_FORCEINLINE void _deallocate_node(cluster_node* node) {
    ...
    MIXX_FORCEINLINE void _insert_back_to(cluster_node* target, cluster_node* node) {
    ...
    MIXX_FORCEINLINE cluster_node* _detach_node(cluster_node* node) noexcept {
...
::allocate() {
    ...
    {
        cluster_node* node;
        if (MIXX_LIKELY(_node_stack.pop(&node))) {
